...
void Semaphore_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,rust::string componentName,uint componentFather);
...
// load src
Fr_sub(&expaux[3],&signalValues[mySignalStart + 1],&circuitConstants[1]); // line circom 7
