...
fn reduce_masked(value: U256) -> U256 {
    // Bitwise results are masked to 254 bits. Since M itself has 254 bits, the value is below 2M
    // and one conditional subtraction is the complete field reduction.
