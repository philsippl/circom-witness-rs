...
The runtime recognizes the numeric specializations of standard `circom-pairing` bigint helpers,
including division, comparison, addition/subtraction, scalar multiplication, signed carry
normalization, modular inversion, and bit splitting. Compatible calls use native bigint arithmetic;
calls with a different signature continue through the portable IR interpreter.
